...
#
#           What is this doing?
#           This exports rankedPeople_df to the csv file specificed by outputFileName variable. The sep=',' refers to seperating information with commas, "index=False" will remove the index column from the csv file, and encoding='utf-8' saves the file with UTF-8 encoding.
